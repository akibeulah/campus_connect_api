...
class UserAdminConfig(UserAdmin):
    ...
    list_display = (
        ...
        'rfid_auth_pin', 'biometrics_auth', 'biometrics_enabled', 'biometrics_password',
        'is_active', 'is_staff', 'is_vendor', 'is_admin', 'is_superuser')
    fieldsets = (
        (None, {'fields': (
            'email', 'username', 'first_name', 'last_name', 'password', 'biometrics_password', 'rfid_auth_id',)}),
        ('Permissions', {'fields': (
            'is_staff', 'is_active', 'is_vendor', 'is_admin', 'rfid_auth', 'rfid_auth_enabled', 'biometrics_auth',
            'rfid_auth_pin', 'biometrics_enabled',)})
    )
    formfield_overrides = {
